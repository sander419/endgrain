...
- **8 генераторов**: мандала, круги на воде, звезда, ромбы, треугольник и ковёр Серпинского,
  пейзаж (небо, солнце, горы, вода), ёлочка. Параметры — лучи, кольца, seed.
...
| `generators.ts` | Генераторы: мандала, фракталы, пейзаж, геометрия |
