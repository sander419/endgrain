...
## Сколько стоит и как получить ключ

| | |
|---|---|
| **Проба, 14 дней** | бесплатно, сразу |
| **Ключ на год** | 4 900 ₽ |
| **Бессрочный ключ** | 12 900 ₽ |

**Проба открывает ровно то же, что покупка.** Урезанная проба показывает
не продукт, а его тень, и решить по ней ничего нельзя. Две недели — это
два-три реальных заказа: достаточно, чтобы понять, экономит инструмент
деньги или нет.

Ключ выдаётся **мастерской, а не компьютеру**: одно юрлицо, ИП или самозанятый
вместе с работниками и рабочими местами. Переносите на любое число машин,
проверяется без интернета.

**Когда срок кончится, сделанное останется.** Заказы, витрина, профиль и журнал
факта лежат в браузере и никуда не денутся — просто перестанут открываться
платные вкладки. Выгрузить всё в файл можно в любой момент, кнопки рядом.

Как получить: написать в Telegram — **[@sander_l](https://t.me/sander_l)** —
и назвать название мастерской. Кнопка и готовый текст запроса есть
в самом приложении: «Моя мастерская» → «Как получить ключ».
